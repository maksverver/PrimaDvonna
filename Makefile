CFLAGS=-g -O2 -m32 -Wall -Wextra -DEXTERN=extern -DTT_DEBUG
LDFLAGS=-m32
LDLIBS=-lm
SRCS=AI.c Crash.c Eval.c Game.c IO.c Time.c TT.c player.c
OBJS=AI.o Crash.o Eval.o Game.o IO.o Time.o TT.o player.o
